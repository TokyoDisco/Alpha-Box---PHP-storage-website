...
<html>
        ...
        <link rel="stylesheet" type="text/css" href="stylesheet.css"/>
	            ...
	            <form method="post" action="sender2.php" >	  
				...
				<!-- 	<tr> -->
						<td id="td2"><img src="images/Make.png" alt="NewFolder" title="Make new folder" width="100" height="100"  onclick="location.href='testF.php'" /> </td>
					<!-- </tr> -->
					
					<!-- <tr> -->
						<td id="tdpng"><img src="images/Rename.png" alt="RenameButton" title="Rename Files" width="100" height="100" />  <input type="text" name="newname" id="foldername" placeholder="New file name" width="10px"></td>
					<!-- </tr> -->
